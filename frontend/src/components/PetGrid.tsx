...
export const PetGrid: React.FC<PetGridProps> = ({
  ...
  // Track keys of pets that were just toggled to encountered for subtle celebratory animation
  ...
  const handleCardClick = (petName: string, currentlyEncountered: boolean) => {
    ...
    // If becoming encountered (from unencountered to encountered), trigger subtle pop animation
