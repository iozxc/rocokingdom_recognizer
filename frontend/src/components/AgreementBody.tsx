    ...
    <div className="space-y-4 text-[13px] leading-relaxed text-slate-600 dark:text-slate-300">
      ...
      <ol className="space-y-3 list-decimal pl-5 marker:text-[#7ABCF4]">
        <li>
          ...
          本程序是面向图像识别与深度学习领域的技术练习作品：它通过截取屏幕画面，结合图像识别、OCR 等识别技术，
          捕获画面中的精灵及相关信息，仅用于图鉴数据的整理与展示、编程学习与技术研究，不代表腾讯官方立场，
          亦不提供任何官方授权。请勿用于商业牟利、批量传播、代练代刷或任何破坏游戏公平性的用途。
          若你仅为测试或学习接触本程序，请在下载、复制或使用后的 24 小时内自行删除全部文件与副本。
        </li>
        <li>
          <b className="text-slate-800 dark:text-slate-100">实现逻辑与边界：</b>
          本程序仅基于屏幕截图与图像识别工作，对画面做纯图像算法层面的识别与分析。
          程序设计明确不访问游戏内存、不注入 DLL、不加载驱动、不修改游戏资源文件，也不对游戏客户端进行任何篡改。
        </li>
        <li>
          <b className="text-slate-800 dark:text-slate-100">风险提示与责任豁免：</b>
          即使本程序不主动访问游戏内存，也无法保证不被游戏、平台或安全系统判定为异常行为。
          游戏官方用户协议通常禁止各类第三方工具，使用者确认已充分知晓该规则；若仍自愿使用本程序，
        ...
        <li>
          ...
          你应自行确认所在地区的法律法规、平台规则、游戏用户协议及社区规范是否允许运行此类程序。
