...
PETS_FILE = get_resource_path(os.path.join('datasets', 'roco_all_pets.json'))
MAP_PETS_FILE1 = get_resource_path(os.path.join('datasets', 'map_pets1.json'))
ALL_PETS_DATA = get_resource_path(os.path.join('datasets', 'map_pets1.json'))
